 ...
 */
  void update(){
    ...
    if (this.bottom > this.view.height - 1) this.position_y = this.view.height - 1 - this.radius;

    if (this.left < 0) this.position_x = this.radius;
    if (this.right > this.view.width - 1) this.position_x = this.view.width - 1 - this.radius;
  }
}